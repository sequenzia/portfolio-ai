...
Both the frontend and backend read from this file.
...
### exp-1: Senior Software Engineer at TechCorp AI
...
Python, TypeScript, React, Kubernetes, TensorFlow, PostgreSQL

---

### exp-2: Full-Stack Engineer at StartupXYZ
...
### exp-3: Frontend Developer at WebAgency Co
...
JavaScript, React, Vue.js, SCSS, Webpack, Jest

---

## Projects

### proj-1: AI Assistant Platform
...
React, Python, FastAPI, LangChain, PostgreSQL, Redis, Docker

---

### proj-2: Real-time Collaboration SDK
...
TypeScript, WebSockets, Yjs, Redis, Node.js

---

### proj-3: DevOps Dashboard
...
React, Go, Kubernetes, Prometheus, Grafana, PostgreSQL

---

### proj-4: E-commerce Mobile App
...
React Native, TypeScript, Node.js, MongoDB, ARKit, TensorFlow Lite

---

## Education

### edu-1: Stanford University
...
- TypeScript: expert, 6 years
- Python: expert, 8 years
- JavaScript: expert, 8 years
- Go: advanced, 3 years
- Rust: intermediate, 1 year
- SQL: advanced, 7 years

### Frontend Development

- React: expert, 6 years
- Next.js: expert, 4 years
- Tailwind CSS: expert, 3 years
- Framer Motion: advanced, 2 years
- React Native: advanced, 2 years
- Vue.js: intermediate, 2 years

### Backend & Infrastructure

- Node.js: expert, 6 years
- PostgreSQL: expert, 6 years
- Kubernetes: advanced, 4 years
- Redis: advanced, 4 years
- AWS: advanced, 5 years
- Docker: expert, 5 years

### AI & Machine Learning

- LLM Integration: expert, 2 years
- Prompt Engineering: expert, 2 years
- LangChain: advanced, 1 year
- TensorFlow: intermediate, 3 years
- PyTorch: intermediate, 2 years
- RAG Systems: advanced, 1 year
